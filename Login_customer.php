...
<header>
	...
	<ul class="menu">
		 ...
		 <li class="menu"><a href="Login_admin.php"><i id="nav-image"></i>ADMIN LOGIN</a></li>
		 <li class="menu"><a href="customer registration.html"><i id="nav-image"></i>REGISTER</a></li>
	</ul>
...
<body style="background-color: white">
	...
	<div class="image">
		<div class="wrapper">
			<h1 class="sign" style=" font-family: 'Architects Daughter', cursive;">Sign in</h1>
